...
function nextMusic(){
    ...
    musicIndex++;
    //if musicIndex is greater than array length then musiIndex will be 1 so the first song will play
...
function prevMusic(){
    ...
    musicIndex--;
    //if musicIndex is less than 1 length then musiIndex will be array length so the last song will play
...
repeatBtn.addEventListener("click", ()=>{
    ...
    switch(getText){
        ...
        case "repeat_one": //if icon is repeat_one then change it to shuffle
            ...
            break;
        case "shuffle": //if icon icon is repeat_one then change it to repeat
    ...
    let getText = repeatBtn.innerText; //getting innerText of icon
       ...
       switch(getText){
        ...
        //generating random index between the max range of array length
            ...
            musicIndex = randIndex; //passing randomIndex to musicIndex to the random song will play
